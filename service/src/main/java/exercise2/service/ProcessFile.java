...
public class ProcessFile{
	...
	public ProcessFile(String filePath, ProcessMap mapOperations){
	...
	public void writeToFile(Map<String, String> tableFormatMap, Map<String, String> dataMap){
		try{		
